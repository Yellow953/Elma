...
class CashReceiptController extends Controller
{
    ...
    {
        $payments = Payment::select('id', 'payment_number', 'client_id', 'type', 'date', 'journal_voucher_id')->where('type', 'LIKE', 'cash receipt')->filter()->orderBy('id', 'desc')->paginate(25);
    ...
    public function create(Request $request)
    {
        ...
        $jv = JournalVoucher::create([
            ...
            'date' => now(),
            'description' => 'Cash Receipt ' . $number . ', automatically generated by system...',
            'status' => 'unposted',
            'source' => 'system',
            'batch' => 'S',
            'created_at' => now(),
    ...
    public function ReturnSave(Request $request)
    {
        ...
        $jv = JournalVoucher::create([
            ...
            'date' => date('Y-m-d'),
            'description' => 'Return Cash Receipt for ' . $old_payment->payment_number . ', automatically generated by system...',
            'status' => 'unposted',
            'source' => 'system',
            'batch' => 'S',
            'created_at' => now(),
