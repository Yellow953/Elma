                            ...
                            <div class="col-md-6">
                                <div class="input-group input-group-outline my-2">
                                    <div class="w-100">
                                        ...
                                        <div>
                                            <input type="tel" class="form-control border" name="phone"
                                                placeholder="Phone" value="{{request()->query('phone')}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="6">{{$users->appends(['name' => request()->query('name'), 'email' =>
                                        ...
                                        request()->query('role'), 'location_id' =>
                                        request()->query('location_id')])->links()}}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
