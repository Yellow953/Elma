  ...
  <div class="row">
    <div class="col-6 col-md-10 d-flex justify-content-end">
      ...
      <div class="dropdown-menu dropdown-menu-right mt-2" aria-labelledby="actionsDropdown">
        ...
        <a class="dropdown-item text-dark" href="{{ route('export.accounts') }}">Export Accounts</a>
        @endif
      </div>
    </div>
          ...
          <form action="{{ route('accounts') }}" method="get" enctype="multipart/form-data">
            <div class="input-group input-group-outline my-2">
              <div class="w-100">
                ...
                <div>
                  <input type="text" class="form-control border" name="account_number" placeholder="Account Number"
              ...
              <div class="w-100">
                ...
                <div>
                  <input type="text" class="form-control border" name="account_description"
                    placeholder="Account Description" value="{{request()->query('account_description')}}">
                </div>
              </div>
            </div>
            <div class="row">
                  ...
                  <div class="w-100">
                    ...
                    <div>
                      <select name="currency_id" id="currency_id" class="form-select select2">
                        ...
                        <option value="{{ $currency->id }}" {{ request()->query('currency_id') == $currency->id ?
                          'selected'
          ...
          <div class="table-responsive p-0">
            <table class="table align-items-center mb-0 text-sm text-dark">
              ...
              <tbody>
                ...
                <tr class="rounded">
                  ...
                  <td>
                    <div class="d-flex flex-row justify-content-center align-items-center">
                      <a href="{{ route('accounts.statement', $account->id) }}" class="btn btn-info btn-custom"
                        title="Statement Of Account">
                        <i class="fa-solid fa-receipt"></i>
                      </a>

                      <a href="{{ route('accounts.edit', $account->id) }}" class="btn btn-warning btn-custom"
                        title="Edit">
                        <i class="fa-solid fa-pen-to-square"></i>
                      </a>
                      @if (auth()->user()->role == 'admin' && $account->can_delete())
                ...
                @endforelse
                <tr>
                  <td colspan="5">{{$accounts->appends(['account_number' => request()->query('account_number'),
                    'type' =>
                    request()->query('type'), 'account_description' =>
                    request()->query('account_description'), 'currency_id' =>
                    request()->query('currency_id')])->links()}}</td>
                </tr>
              </tbody>
            </table>
          </div>
