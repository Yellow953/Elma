...
<div class="container-fluid px-2 px-md-4">
  ...
  <div class="card card-body mx-1 mx-md-4 mt-n6">
    ...
    <h5 class="mt-2 text-decoration-underline">Warehouses</h5>
    <div class="row my-2 ">
      <div class="col-md-6">
        <form action="{{ route('import.warehouses') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="d-flex flex-row">
            <input type="file" name="warehouses" required class="input-field">
            <button type="submit" class="btn btn-info mx-2 py-2 px-3">Import</button>
          </div>
        </form>
      </div>
      <div class="col-md-6">
        <a href="{{ route('export.warehouses') }}" class="text-center btn btn-info mx-2 py-2 px-3">
          Export
        </a>
      </div>
    </div>
    ...
    <h5 class="mt-2 text-decoration-underline">Projects</h5>
    <div class="row my-2 ">
      <div class="col-md-6">
        <form action="{{ route('import.projects') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="d-flex flex-row">
            <input type="file" name="projects" required class="input-field">
            <button type="submit" class="btn btn-info mx-2 py-2 px-3">Import</button>
          </div>
        </form>
      </div>
      <div class="col-md-6">
        <a href="{{ route('export.projects') }}" class="text-center btn btn-info mx-2 py-2 px-3">
          Export
        </a>
      </div>
    </div>
    ...
    <div class="row my-2">
      <div class="col-md-6">
        <form action="{{ route('export.supplier_items') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="d-flex flex-row">
            <input type="text" name="supplier" autocomplete="supplier" placeholder="Supplier" required
              class="input-field form-control">
            <button type="submit" class="btn btn-info mx-2 py-2 px-3">Export Supplier</button>
          </div>
        </form>
      </div>

      <div class="col-md-6">
        <form action="{{ route('export.active_items') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="d-flex flex-row">
            <select name="warehouse" required class="input-field form-select select2">
              <option></option>
              @foreach (Helper::get_warehouses() as $warehouse)
              <option value="{{$warehouse->id}}">{{$warehouse->name}}</option>
              @endforeach
            </select>
            <button type="submit" class="btn btn-info mx-2 py-2 px-3">Export Active</button>
          </div>
        </form>
      </div>
    </div>
    ...
    <h5 class="mt-2 text-decoration-underline">TROS</h5>
    <div class="row my-2 ">
      <div class="col-md-6">
        <form action="{{ route('import.tros') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="d-flex flex-row">
            <input type="file" name="tros" required class="input-field">
            <button type="submit" class="btn btn-info mx-2 py-2 px-3">Import</button>
          </div>
        </form>
      </div>
      <div class="col-md-6">
        <a href="{{ route('export.tros') }}" class="text-center btn btn-info mx-2 py-2 px-3">
          Export
        </a>
      </div>
    </div>
    <h6 class="mt-2">TRO Items</h6>
    <div class="row my-2 ">
      <div class="col-md-6">
        <form action="{{ route('import.tro_items') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="d-flex flex-row">
            <input type="file" name="tro_items" required class="input-field">
            <button type="submit" class="btn btn-info mx-2 py-2 px-3">Import</button>
          </div>
        </form>
      </div>
      <div class="col-md-6">
        <a href="{{ route('export.tro_items') }}" class="text-center btn btn-info mx-2 py-2 px-3">
          Export
        </a>
      </div>
    </div>
