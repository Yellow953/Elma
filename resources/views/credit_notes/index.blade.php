    ...
    <div class="row">
        <div class="col-6 col-md-10 d-flex justify-content-end">
            ...
            <div class="dropdown-menu dropdown-menu-right mt-2" aria-labelledby="actionsDropdown">
                <a class="dropdown-item text-dark" href="{{ route('credit_notes.new') }}">New Credit
                    Note</a>
                @if (auth()->user()->role == 'admin')
                <a class=" dropdown-item text-dark" href="{{ route('export.cdnotes') }}">Export Credit Notes</a>
                <a class=" dropdown-item text-dark" href="{{ route('export.cdnote_items') }}">Export Credit Note
                    Items</a>
                @endif
            </div>
        </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="6">
                                        ...
                                        request()->query('cdnote_number'), 'client_id' =>
