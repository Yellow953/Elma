                    ...
                    <form action="{{ route('purchase_orders.SaveItems', $purchase_order->id) }}" method="post">
                        ...
                        <div class="w-100 text-end" id="end_result">
                            <button class="btn btn-info btn-block my-3 ignore-confirm"
                                id="add-po-form-btn">Save</button>
                        </div>
                    </form>
                </div>
            </div>
                ...
                if (data.length <= 0) {
                    ...
                    htmlView += `
                        ...
                        <td>
                            ...
                            data-id="${data[i].id}" class="btn btn-success bg-success add-item-btn">
