...
<div class="inner-container">
    ...
    <div class="card">
        <div class="card-header bg-info border-b bg-info border-b">
            <h4 class="font-weight-bolder">New Tax</h4>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('taxes.create') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="input-group input-group-outline row my-3">
                    ...
                    <div class="col-md-6">
                        <select name="account_id" id="account_id" required class="form-select select2">
                            ...
                            <option value="{{ $account->id }}" {{ $account->id == old('account_id') ?
                                'selected' : '' }}>{{
                ...
                <div class="input-group input-group-outline row my-3">
                    ...
                    <div class="col-md-6">
                        <input id="rate" type="number" value="{{ old('rate') }}"
                            class=" form-control @error('rate') is-invalid @enderror" name="rate" required
                            autocomplete="rate" step="any" min="0" max="100">
