                        ...
                        <div class="col-md-6">
                            <div class="form-group mt-3">
                                ...
                                <input id="container_number" type="text" placeholder="Enter Container Number" required
                                    ...
                                    name="container_number" value="{{ $shipment->container_number }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mt-3">
                                ...
                                <input id="consignee_name" type="text" placeholder="Enter Consignee Name" required
                                    ...
                                    name="consignee_name" value="{{ $shipment->consignee_name }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mt-3">
                                ...
                                <select name="consignee_country" id="consignee_country" required
                                    ...
                                    <option value="{{ $country }}" {{ $country==$shipment->consignee_country ?
                                        'selected'
                                        : '' }}>
                                        {{ $country }}
                                    </option>
