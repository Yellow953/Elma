...
@else
<div class="print">
	<a href="{{ route('po.print', $po->id) }}" class="btn btn-primary m-3">Print</a>
</div>

{{-- @if (auth()->user()->role == 'admin' && isset($po->project->client))
<div class="send">
	<a href="{{ route('po.send', $po->id) }}" class="btn btn-primary m-3">Send</a>
</div>
@endif --}}
