...
<div class="inner-container w-100 m-0 p-5">
    <div class="card">
        <div class="card-header bg-info border-b">
            <h4 class="font-weight-bolder">Return Cash Receipt</h4>
        </div>
        <div class="card-body">
            <div class="container px-0 px-md-5">
                ...
                <form role="form" action="{{ route('cash_receipts.return_save') }}" method="post"
                    ...
                    <div class="row setup-content" id="step-1">
                        <div class="offset-md-2 col-md-8">
                            ...
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    <p class="text-center">Please select the Payment you want to return</p>
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Payment *</label>
                                    <select name="payment_id" id="payment_id" required="required"
                                        class="form-select select2">
                                        <option value=""></option>
                                        @foreach ($payments as $payment)
                                        <option value="{{ $payment->id }}" {{ $payment->id == old('payment_id') ?
                                            'selected':'' }}>{{ $payment->payment_number }}</option>
                                        @endforeach
                                    </select>
                                </div>
                    ...
                    <div class="row setup-content" id="step-2">
                        <div class="offset-md-2 col-md-8">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <p class="text-center">
                                        Please select the Items you want to return from this Payment
                                    </p>
                                </div>
...
<script>
    $(document).ready(function () {
        ...
        $('#payment_id').on('change', function () {
            ...
            if (payment_id) {
                $.ajax({
                    url: '/cash_receipts/' + payment_id + '/items',
                    type: 'GET',
                    dataType: 'json',
