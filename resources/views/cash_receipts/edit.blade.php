...
<div class="inner-container w-100 m-0 p-5">
    ...
    <div class="card">
        <div class="card-header bg-info border-b">
            <h4 class="font-weight-bolder">Edit Cash Receipt</h4>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('cash_receipts.update', $payment->id) }}"
                ...
                <h5 class="mt-5 text-center">Cash Receipt Items</h5>
